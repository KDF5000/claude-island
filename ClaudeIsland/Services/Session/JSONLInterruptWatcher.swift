...
private let logger = Logger(subsystem: "com.codingisland", category: "Interrupt")
...
class JSONLInterruptWatcher {
    ...
    private let queue = DispatchQueue(label: "com.codingisland.interruptwatcher", qos: .userInteractive)
